        ...
        {acctEntries.length > 0 && (
          <div className="obsidian-card" style={{ ...S.card, padding: "14px 16px", marginBottom: 12 }}>
            ...
            {calendarSplitView === "full" ? (
              ...
              <div>
              <div style={{fontSize:10,color:"var(--t3)",textTransform:"uppercase",letterSpacing:"1px",fontWeight:700,fontFamily:"var(--font-disp)",marginBottom:8}}>Expected Expenses</div>
              {/* First half: 1–15 */}
