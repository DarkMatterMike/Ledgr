...
const CSS = `
  ...
  .lb-frame{background:var(--bg-0);border:none;border-radius:0;overflow:hidden;max-width:none;margin:0;box-shadow:none;}
...
Reply with ONLY: {"name":"max 8 word label","delta":positiveNumber,"positive":trueOrFalse}`;
  ...
  return(
    <>
      <style>{CSS}</style>
      <div className="lb-wrap" style={isMobile?{padding:0,minHeight:"unset"}:{}}>
        <div className="lb-frame">
          ...
          <div className="lb-brief" style={isMobile?{display:"block",width:"100%",minHeight:"unset"}:{}}>
            ...
            {/* main */}
            <main className="lb-main" style={isMobile?{padding:"16px 16px 90px",overflowY:"unset"}:{}}>
